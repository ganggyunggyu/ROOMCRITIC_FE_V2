...
export const ReviewCard: React.FC<ReviewCardProps> = ({ review, className }) => {
  return (
    <div
      ...
      className={cn(
        `flex flex-row gap-3 border border-solid  border-slate-400 w-86 h-52 md:h-72 p-4 rounded-md dark:bg-zinc-700 bg-zinc-100 ${className}`,
      )}
    >
      <div className='flex flex-col w-full gap-3 relative'>
        ...
        <div className='flex items-center justify-between gap-2 w-full absolute bottom-0'>
